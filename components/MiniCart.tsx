...
export default function MiniCart({ isOpen, onClose }: MiniCartProps) {
  ...
  return (
    <>
      <div
        className="fixed inset-0 bg-primary-dark/40 z-40 transition-opacity"
        onClick={onClose}
      ></div>
            ...
            <div className="border-t border-gray-200 p-6 bg-gray-50">
              ...
              <div className="space-y-3">
                <Link
                  href="/checkout"
                  onClick={onClose}
                  className="block w-full py-4 bg-primary text-white text-center rounded-lg font-semibold hover:bg-primary-dark transition-colors whitespace-nowrap cursor-pointer"
                >
                  Proceed to Checkout
                </Link>
                <Link
                  href="/cart"
                  onClick={onClose}
                  className="block w-full py-4 border-2 border-primary text-primary text-center rounded-lg font-semibold hover:bg-primary-soft transition-colors whitespace-nowrap cursor-pointer"
                >
                  View Cart
                </Link>
              </div>
