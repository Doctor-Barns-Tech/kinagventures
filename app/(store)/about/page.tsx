...
export default function AboutPage() {
  ...
  const storyImage = getSetting('about_story_image') || HERO_IMAGES_OTHER_PAGES[1];
      ...
      <section className="bg-stone-50 py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="bg-primary p-10 lg:p-14 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group text-white">
              ...
              <p className="text-gray-300 text-lg leading-relaxed font-light">
                {mission2Content || 'Quality shouldn\'t be exclusive. Our mission is to offer quality at fair prices. We believe everyone deserves the best, regardless of budget.'}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-stone-50 p-8 rounded-2xl hover:bg-white hover:shadow-xl transition-all duration-300 border border-transparent hover:border-gray-100 group">
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mb-6 shadow-sm group-hover:bg-primary transition-colors duration-300">
